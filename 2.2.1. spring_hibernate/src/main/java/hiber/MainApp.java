...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      Car car = new Car("Volvo1", 2281);

      User user1 = new User("User1", "Lastname1", "user1@mail.ru", car);
      User user2 = new User("User2", "Lastname2", "user2@mail.ru", new Car("Volvo2", 2282));
      ...
      System.out.println(userService.getUserByCarModelAndSeries("Volvo3", 2283));
